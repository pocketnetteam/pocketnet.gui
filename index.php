...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="css/master.css?v=66020042202">

        <link rel="icon" href="./favicon.svg" sizes="any" type="image/svg+xml">
        <link rel="stylesheet" href="css/fontawesome/css/all.css">

        <script src="js/vendor/device.min.js?v=250881717729"></script>
        <script src="js/vendor/modernizr-2.8.3.min.js?v=250881717729"></script>
    ...
    <body id="application" class="menu-hide">
       ...
       <!-- <script src="cordova.js"></script>-->
        ...
        <script src="js/vendor/jquery-1.11.3.min.js?v=250881717729"></script>
        ...
        <script join src="js/join.min.js?v=198135028447"></script>
