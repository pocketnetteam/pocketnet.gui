	...
	var Essense = function(p){
		...
		var faqLangs = {
			...
			ru : [
				...
				{
				id : 'адреса кошельков',
				q : 'Я вижу адрес аккаунта и адрес кошелька... Оба эти адреса находятся в цепочке блоков PN? Связаны ли они между собой?',
