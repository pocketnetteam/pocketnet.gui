...
<body>
    ...
    <p>
        __VAR__.lname built the __VAR__.name app as an Open Source app. This SERVICE is provided by __VAR__.lname at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at __VAR__.name unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
        For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to Name. The information that we request will be retained by us and used as described in this
        privacy policy.
    </p>
    <div>
        <p>
        ...
        <ul>
            <li><a elementsid="https://www.google.com/policies/privacy/" href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer">Google Play Services</a></li>
            <!---->
            <!---->
            <!---->
            <!---->
    ...
    <p>This policy is effective as of 2021-08-10</p>
    <p><strong>Contact Us</strong></p>
    <p>
        If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at __VAR__.support.
    </p>
</body>
