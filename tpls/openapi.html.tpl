...
<html class="no-js openapipnet customscroll" lang="">
    ...
    <body id="application" class="menu-hide openapi openapipnet">
        ...
        <div class="calltoaction"> 
            <div class="text">
                <span>
                    A Revolutionary anti-censorship decentralized publishing and social platform.
                </span>
            </div> 
