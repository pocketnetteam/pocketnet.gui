...
____loclib.easyNode_e10013 = "Установить каталоги по умолчанию"
...
____loclib.easyNode_e10037 = function(v) { return `Осталось менее ${v} часов` }
...
____loclib.easyNode_e10052 = "Убедитесь, что вы сделали резервную копию кошелька. Вы действительно хотите удалить каталог данных узла?"
...
____loclib.easyNode_e10055 = "Вы действительно хотите установить пути по умолчанию?"
____loclib.easyNode_e10056 = "ГБ Оперативной Памяти"
____loclib.easyNode_e10057 = "ядерный процессор"
...
____loclib.easyNode_e2000 = "Хотели бы вы бороться с корпоративной цензурой и одновременно зарабатывать криптовалюту?";
...
____loclib.easyNode_e2002 = "А что такое нода? Нода это компьютер любого пользователя, который поддерживает сеть Бастион и получает за это Покеткойны. Вы можете быть владельцем такого компьютера, если у вас компьютер где есть 50 гигабайт ССД памяти и хорошее интернет соединение. За поддержку сети Бастион, ваша нода будет получать Покеткойны. Заработок Покеткойна будет пропорционален количеству Покеткойнов, которое вы положите в свою ноду. В криптовалютах такой алгоритм называется стейкинг.";
