...
____loclib.ratings123 = "Только пользователи с высокой репутацией могут ставить 1, 2, 3 звезды. Это сделано для защиты авторов, потому что в Бастионе личные данные НЕ требуются."