...
____loclib.pinned = "закреплённая публикацию"
...
____loclib.aboutHowItWImgAndText27 = 'Вы можете зарегистрироваться, не сообщая свой номер телефона (требуется только электронная почта)';
