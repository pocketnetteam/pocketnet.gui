...
____loclib.pbp_6_3 = 'Важно: Начиная с 1-го ноября вступает в силу дополнительное ограничение: вы должны иметь +1250 реферальных пользователей для получения каждого бонуса. Чтобы привлечь реферальных пользователей включайте реферальную часть в ссылку в окне "Поделиться".'
