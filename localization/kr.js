...
____loclib.congratulations = '축하합니다! 당신이 이 안에 있습니다 <span class="pnlabel">Pocketnet</span>'
...
____loclib.next = "다음";
____loclib.welcometopocketnet = "Pocketnet에 오신 것을 환영합니다";
...
____loclib.donationwel = "저자에게 감사를 표하고 싶다면 Pocketnet 거래를 사용할 수 있습니다.";
____loclib.donationwela = "Pocketnet 거래";
...
____loclib.utip1 = "Pocketnet을 사용하기 전에 블록 체인에 이름과 아바타를 생성해야 합니다";
...
____loclib.joined = "연결된 Pocketnet";
...
____loclib.firstShare = "Pocketnet에서 첫 게시물 공유";
...
____loclib.maximages = "최대 또는 6 개의 이미지가 허용되었습니다";
...
____loclib.error = "오류";
____loclib.checkScoreError = "Pocketnet을 사용하기 전에 필요한 프로필 정보를 입력해야 합니다. 지금 입력 하시겠습니까?";
...
____loclib.next = "다음"
____loclib.post = "게시"
____loclib.e13041 = "Pocketnet 연결"
____loclib.e13042 = "Pocketnet 프록시"

____loclib.e13043 = "Pocketnet 노드"
...
____loclib.e13079 = "Pocketnet을 사람들에게 제공하는 정규업무로 14개월 이상의 추가시간을 투자했습니다. 시간과 노력 외에도 플랫폼 출시를 돕기 위해 자체자금을 투입했습니다. 이제 우리는 성장을 위한 커뮤니티가 필요합니다."
____loclib.e13080 = "기금은 어떻게 사용됩니까?"
____loclib.e13081 = "기금은 광고를 구매하고 Pocketnet을 더욱 안전하게 만들기 위해 특정 분야의 전문가를 고용하는 데 사용됩니다. 현재 개발팀은 이러한 기부금을 받지 않습니다. 가능한 경우 여기에 기금 사용 방법을 게시할 것입니다. "
____loclib.e13082 = "자유를 지지했다는 사실 외에 기부로 얻을 수있는 혜택 :"
____loclib.e13083 = "기부에 대한 감사의 표시로 약간의 Pocketcoin 선물을 받게 됩니다."
____loclib.e13084 = "또한, 그룹 채팅을 구축할 때 귀하는 플랫폼이 성장하더라도 Pocketnet팀에 직접 액세스할 수있는 특별한 기부자 그룹의 구성원이 됩니다."
____loclib.e13085 = "Pocketnet 프로필에 대한 링크가 아래에 나열되어 더 많은 사람들이 귀하의 게시물로 이동하도록 유도합니다 (그렇게하지 말라고 요청하지 않는 한)"
____loclib.e13086 = "지금 분산 웹 지원"
____loclib.e13087 = "비트 코인, 라이트 코인, 모네로"

____loclib.e13088 = "Pocketnet을 지원하기 위해 기부한 Pocketnet 회원"
____loclib.thankyou = "감사합니다!"
____loclib.e13089 = "Pocketnet 프로필을 기부자 목록에 나열하려면 기부에 대한 정보를 보내주십시오"
...
____loclib.e13106 = "Pocketnet 노드"
...
____loclib.e13111 = "최신 Pocketnet 업데이트를 받으려면 이메일을 추가하십시오."
...
____loclib.e13124 = "더 멋진 Pocketnet 게시물!"
...
____loclib.e13139 = "Pocketnet에서 검색"
...
____loclib.e13155 = "Pocketnet을 사용하려면 중앙 소셜네트워크에서 로그인과 암호를 대체하는 개인 암호화 키를 생성해야 합니다."
...
____loclib.copy = "복사"
____loclib.e13170 = "Pocketnet 가입 클릭 유도 문안 포함"
____loclib.more = "더보기"
____loclib.e13171 = "좋은 소식입니다. 소셜 미디어 독점으로부터 독립을 얻었습니다. pocketnet.app에서 저와 함께 블록 체인에서 독립적으로 공유하고 채팅할 수 있습니다. 여기에 참여하세요"
____loclib.e13172 = "분산형 블록 체인 플랫폼 Pocketnet에서 이것을 공유하고 싶습니다. 유용하다고 생각하신다면 가입하여, 우리 둘 다 Pocketcoin 암호화폐 보너스를 받을 수 있기를 바랍니다!"
...
____loclib.e13190 = "Pocketnet 테마"
...
____loclib.e13199 = "지금 Pocketnet 가입"

____loclib.e13200 = "Pocketnet으로 돌아가기"
____loclib.e13201 = "베타 참여"
____loclib.e13202 = "Pocketnet 베타 테스트는 1월 24일에 시작됩니다."
____loclib.e13203 = "Pocketnet 베타 테스트 이메일 목록에 참여해 주셔서 감사합니다. 반드시 Pocketnet을 사용할 필요는 없지만 이 이메일을 사용하여 플랫폼을 개선하기 위해 설문 조사를 보낼 것입니다. 인터넷의 미래를 형성하는 데 도움을 주셔서 감사합니다. "
____loclib.e13204 = "Pocketnet 수신 주소"
...
____loclib.e13227 = "Windows 용 Pocketnet 노드 다운로드"
____loclib.e13228 = "Linux 용 Pocketnet 노드 다운로드"
...
____loclib.e13257 = 'Pocketnet 평판 점수는 아직 불만 등록을 허용하지 않습니다.'
...
____loclib.e13278 = '자동으로 Pocketnet 시작'
...
____loclib.e13347 = "Pocketnet 업데이트를 사용할 수 있습니다. 지금 업데이트를 적용 하시겠습니까?"
____loclib.e13348 = "아니요, 나중에"
____loclib.e13349 = "Pocketnet 업데이트를 사용할 수 있습니다. 새 버전을 다운로드하려면 페이지로 이동 하시겠습니까?"
____loclib.e13350 = '지금 Pocketnet 가입 및 Pocketcoin 적립'
____loclib.e13351 = '사람들이 당신을 따르기를 원하는지 결정할 수 있도록 당신에 대해 몇 마디 적어주세요'