...
fs.exists(mapJsPath, function (exists) {
  if (exists) {
    ...
    var cordova = {
      ...
      copy: [
        'chat', 'components', 'css', 'images', 'img', 'js',
        'localization', 'peertube', 'sounds', 'browserconfig.xml',
        'crossdomain.xml', 'favicon.svg', 'favicon.ico', 'indexcordova.html'
      ]
    }
    ...
    makePocketnet(function () {
      ...
      copycontent(cordovaconfig, function () {}, true)
...
if (!String.prototype.replaceAll) {
  String.prototype.replaceAll = function (a, b) {
    return a ? this.split(a).join(b) : this
  };
}
