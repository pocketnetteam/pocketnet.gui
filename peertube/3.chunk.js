...
class HybridLoader extends events__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"] {
    constructor(settings = {}) {
        ...
        this.processSegmentsQueue = (storageSegments) => {
            this.debugSegments("process segments queue. priority", this.segmentsQueue.length > 0 ? this.segmentsQueue[0].priority : 0, this.segmentsQueue);
        ...
        this.debugSegments.enabled = false;
...
/* harmony import */ var hls_js_src_loader_load_stats__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! hls.js/src/loader/load-stats */ "./node_modules/hls.js/src/loader/load-stats.ts");
/**
 * Copyright 2018 Novage LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
        ...
        return _a = class {
                constructor() {
                    this.load = (context, config, callbacks) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                        ...
                        console.log('this.impl.load', config, this.stats);
                    ...
                    this.stats = new hls_js_src_loader_load_stats__WEBPACK_IMPORTED_MODULE_5__["LoadStats"]();
                }
...
class HlsJsLoader {
                    ...
                    if (content !== undefined) {
                        ...
                        if (aborted) {
                            ...
                            if (callbacks.onAbort)
                                callbacks.onAbort(stats, context, undefined);
                        }
                    }
                }
                catch (e) {
    ...
    successPlaylist(xhr, context, callbacks, stats) {
        ...
        if (callbacks === null || callbacks === void 0 ? void 0 : callbacks.onProgress)
            callbacks.onProgress(stats, context, xhr.response, undefined);
        callbacks.onSuccess({
            url: xhr.responseURL,
            data: xhr.response,
...
class SegmentManager {
    constructor(loader, settings = {}) {
        ...
        this.onSegmentLoaded = (segment) => {
            if (this.segmentRequest &&
                ...
                // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                this.segmentRequest.onSuccess(segment.data.slice(0), segment.downloadBandwidth, false);
                this.segmentRequest = null;
            }
        };
    ...
    loadSegment(url, byteRange) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.segmentRequest) {
                console.error("Cancel segment request: simultaneous segment requests are not supported");
                this.segmentRequest.onError("Cancel segment request: simultaneous segment requests are not supported");
            }
            const promise = new Promise((resolve, reject) => {
                this.segmentRequest = new SegmentRequest(url, byteRange, segmentSequence, segmentLocation.playlist.requestUrl, (content, downloadBandwidth, aborted) => resolve({ content, downloadBandwidth, aborted: aborted || false }), (error) => reject(error));
            });
    ...
    abortSegment(url, byteRange) {
        if (this.segmentRequest &&
            ...
            this.segmentRequest.onSuccess(undefined, 0, true);
            this.segmentRequest = null;
        }
    }
    destroy() {
