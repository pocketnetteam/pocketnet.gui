...
class http_media_manager_HttpMediaManager extends http_media_manager_FilteredEmitter {
    constructor(settings) {
        ...
        this.download = (segment, downloadedPieces) => Object(tslib_es6["a" /* __awaiter */])(this, void 0, void 0, function* () {
        ...
        this.setupFetchEvents = (fetch, segment, downloadedPieces) => Object(tslib_es6["a" /* __awaiter */])(this, void 0, void 0, function* () {
        ...
        this.segmentDownloadFinished = (segment, data, fetchResponse) => Object(tslib_es6["a" /* __awaiter */])(this, void 0, void 0, function* () {
...
class engine_Engine extends events["EventEmitter"] {
    constructor(settings = {}) {
        ...
        this.segmentManager = new segment_manager_SegmentManager(this.loader, settings);
