...
/* harmony import */ var _peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @peertube/p2p-media-loader-core */ "./node_modules/@peertube/p2p-media-loader-core/dist/index.js");
/* harmony import */ var _peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _peertube_p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @peertube/p2p-media-loader-hlsjs */ "./node_modules/@peertube/p2p-media-loader-hlsjs/dist/index.js");
/* harmony import */ var _peertube_p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_peertube_p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_2__);
...
class P2pMediaLoaderPlugin extends Plugin {
    constructor(player, options) {
        ...
        if (!(video_js__WEBPACK_IMPORTED_MODULE_0___default().Html5Hlsjs)) {
            ...
            (0,_peertube_p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_2__.initVideoJsContribHlsJsPlayer)(player);
        }
    ...
    initializePlugin() {
        (0,_peertube_p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_2__.initHlsJsPlayer)(this.hlsjs);
        this.p2pEngine = this.options.loader.getEngine();
        this.p2pEngine.on(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__.Events.SegmentError, (segment, err) => {
    ...
    runStats() {
        this.p2pEngine.on(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__.Events.PieceBytesDownloaded, (method, _segment, bytes) => {
            const elem = method === 'p2p' ? this.statsP2PBytes : this.statsHTTPBytes;
            elem.pendingDownload.push(bytes);
            elem.totalDownload += bytes;
        });
        this.p2pEngine.on(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__.Events.PieceBytesUploaded, (method, _segment, bytes) => {
            const elem = method === 'p2p' ? this.statsP2PBytes : this.statsHTTPBytes;
            elem.pendingUpload.push(bytes);
            elem.totalUpload += bytes;
        });
        this.p2pEngine.on(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__.Events.PeerConnect, () => this.statsP2PBytes.numPeers++);
        this.p2pEngine.on(_peertube_p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_1__.Events.PeerClose, () => this.statsP2PBytes.numPeers--);
