...
/* harmony export */   "EventRegistrar": () => (/* binding */ EventRegistrar)
/* harmony export */ });
...
let EventRegistrar = /*#__PURE__*/function () {
  ...
  _createClass(EventRegistrar, [{
    key: "bindToChannel",
    value: function bindToChannel(channel) {
    ...
    key: "registerTypes",
    value: function registerTypes(names) {
      for (const name of names) {
        this.eventRegistrations[name] = {
          registrations: []
        };
      }
    }
    ...
    key: "addListener",
    value: function addListener(name, handler) {
    ...
    key: "removeListener",
    value: function removeListener(name, handler) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PeerTubePlayer": () => (/* binding */ PeerTubePlayer)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var jschannel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jschannel */ "./node_modules/jschannel/src/jschannel.js");
/* harmony import */ var jschannel__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jschannel__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events */ "./src/standalone/player/events.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
const PASSTHROUGH_EVENTS = ['pause', 'play', 'playbackStatusUpdate', 'playbackStatusChange', 'resolutionUpdate', 'volumeChange'];
/**
 * Allows for programmatic control of a PeerTube embed running in an <iframe>
 * within a web page.
 */

let PeerTubePlayer = /*#__PURE__*/function () {
  /**
  ...
  function PeerTubePlayer(embedElement, scope) {
    _classCallCheck(this, PeerTubePlayer);

    this.embedElement = embedElement;
    this.scope = scope;
    this.eventRegistrar = new _events__WEBPACK_IMPORTED_MODULE_1__.EventRegistrar();
  ...
  _createClass(PeerTubePlayer, [{
    ...
    key: "setCaption",
    value: function setCaption(value) {
      return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
    ...
    key: "setResolution",
    value: function setResolution(resolutionId) {
      return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
    ...
    key: "getPlaybackRates",
    value: function getPlaybackRates() {
      return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
    ...
    value: function playPreviousVideo() {
      return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
    ...
    key: "constructChannel",
    value: function constructChannel() {
      this.channel = jschannel__WEBPACK_IMPORTED_MODULE_0__.build({
    ...
    key: "prepareToBeReady",
    value: function prepareToBeReady() {
      let readyResolve;
      let readyReject;
...
(function (root, factory) {
  ...
  var Channel = function () {
    ...
    var s_curTranId = Math.floor(Math.random() * 1000001); // no two bound channels in the same javascript evaluation context may have the same origin, scope, and window.
    ...
    var s_boundChans = {}; // add a channel to s_boundChans, throwing if a dup exists
    ...
    var s_transIds = {}; // class singleton onMessage handler
    ...
    var s_onMessage = function (e) {
      ...
      if (typeof m.id !== 'undefined') i = m.id; // w is message source window
      // o is message origin
      // m is parsed message
      // s is message scope
    ...
    return {
      build: function (cfg) {
        ...
        if (window === cfg.window) debug("target window is same as present window -- use at your own risk"); // let's require that the client specify an origin.  if we just assume '*' we'll be
        ...
        if (typeof cfg.origin === 'string') {
          var oMatch;
          if (cfg.origin === "*") validOrigin = true; // allow valid domains under http and https.  Also, trim paths off otherwise valid origins.
        ...
        var regTbl = {}; // current oustanding sent requests

        var outTbl = {}; // current oustanding received requests

        var inTbl = {}; // are we ready yet?  when false we will block outbound messages.
        ...
        var createTransaction = function (id, origin, callbacks) {
          ...
          return {
            ...
            invoke: function (cbName, v) {
              // verify in table
              if (!inTbl[id]) throw "attempting to invoke a callback of a nonexistent transaction: " + id; // verify that the callback name is valid
              ...
              if (!valid) throw "request supports no such callback '" + cbName + "'"; // send callback invocation
            ...
            error: function (error, message) {
              completed = true; // verify in table

              if (!inTbl[id]) throw "error called for nonexistent message: " + id; // remove transaction from table

              delete inTbl[id]; // send error
            ...
            complete: function (v) {
              ...
              if (!inTbl[id]) throw "complete called for nonexistent message: " + id; // remove transaction from table

              delete inTbl[id]; // send complete
        ...
        var onMessage = function (origin, method, m) {
          ...
          if (m.id && method) {
            inTbl[m.id] = {};
            var trans = createTransaction(m.id, origin, m.callbacks ? m.callbacks : []); // a request!  do we have a registered handler for this request?
            ...
            if (regTbl[method]) {
              try {
                ...
                var message = null; // * if it's a string then it gets an error code of 'runtime_error' and string is the message
            ...
            if (regTbl[method]) {
              ...
              regTbl[method]({
                origin: origin
              }, m.params); // if the client throws, we'll just let it bubble out
        ...
        s_addBoundChan(cfg.window, cfg.origin, cfg.scope, onMessage); // scope method names based on cfg.scope specified when the Channel was instantiated
        ...
        var postMessage = function (msg, force) {
          if (!msg) throw "postMessage called with null message"; // delay posting if we're not ready yet.
        ...
        var onReady = function (trans, params) {
          ...
          ready = true; // only append suffix to chanId once:
          ...
          publishQueue = []; // invoke onReady observer if provided
        ...
        var obj = {
          ...
          call: function (m) {
            ...
            if (!m.success || typeof m.success !== 'function') throw "'success' callback missing from call"; // now it's time to support the 'callback' feature of jschannel.  We'll traverse the argument
            ...
            pruneFunctions("", m.params); // build a 'request' message and send it
            ...
            if (m.timeout) // XXX: This function returns a timeout ID, but we don't do anything with it.
              // We might want to keep track of it so we can cancel it using clearTimeout()
              // when the transaction completes.
              setTransactionTimeout(s_curTranId, m.timeout, scopeMethod(m.method)); // insert into the transaction table
            ...
            s_transIds[s_curTranId] = onMessage; // increment current id
          ...
          notify: function (m) {
            ...
            if (!m.method || typeof m.method !== 'string') throw "'method' argument to notify must be string"; // no need to go into any transaction table
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _test_embed_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./test-embed.scss */ "./src/standalone/videos/test-embed.scss");
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../player/player */ "./src/standalone/player/player.ts");



window.addEventListener('load', () => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(void 0, void 0, void 0, function* () {
  ...
  iframe.src = isPlaylist ? `/video-playlists/embed/${elementId}?api=1` : `/videos/embed/${elementId}?api=1`;
  const mainElement = document.querySelector('#host');
  mainElement.appendChild(iframe);
  console.log(`Document finished loading.`);
  const player = new _player_player__WEBPACK_IMPORTED_MODULE_1__.PeerTubePlayer(document.querySelector('iframe'));
  window['player'] = player;
  console.log(`Awaiting player ready...`);
  yield player.ready;
  console.log(`Player is ready.`);
  const monitoredEvents = ['pause', 'play', 'playbackStatusUpdate', 'playbackStatusChange'];
  monitoredEvents.forEach(e => {
    ...
    player.getCurrentPosition().then(position => document.getElementById('playlist-position').innerHTML = position + '');
  });
  let playbackRates = [];
  let currentRate = yield player.getPlaybackRate();

  const updateRates = () => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(void 0, void 0, void 0, function* () {
  ...
  const updateCaptions = () => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(void 0, void 0, void 0, function* () {
