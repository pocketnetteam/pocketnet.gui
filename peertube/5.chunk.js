...
/* harmony import */ var hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! hls.js/dist/hls.light.js */ "./node_modules/hls.js/dist/hls.light.js");
/* harmony import */ var hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__);
// Thanks https://github.com/streamroot/videojs-hlsjs-plugin
// We duplicated this plugin to choose the hls.js version we want, because streamroot only provide a bundled file

const registerSourceHandler = function (vjs) {
    if (!hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["isSupported"]()) {
...
class Html5Hlsjs {
    ...
    _handleMediaError(error) {
        if (this.errorCounts[hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].MEDIA_ERROR] === 1) {
            console.info('trying to recover media error');
            this.hls.recoverMediaError();
            return;
        }
        if (this.errorCounts[hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].MEDIA_ERROR] === 2) {
    ...
    _handleNetworkError(error) {
        if (this.errorCounts[hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].NETWORK_ERROR] <= 5) {
            console.info('trying to recover network error');
            // Wait 1 second and retry
            setTimeout(() => this.hls.startLoad(), 1000);
            // Reset error count on success
            this.hls.once(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["Events"].FRAG_LOADED, () => {
                this.errorCounts[hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].NETWORK_ERROR] = 0;
            });
            return;
        }
    ...
    _onError(_event, data) {
        ...
        if (!data.fatal)
            return;
        if (data.type === hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].NETWORK_ERROR) {
            error.code = 2;
            this._handleNetworkError(error);
        }
        else if (data.type === hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].MEDIA_ERROR && data.details !== 'manifestIncompatibleCodecsError') {
            error.code = 3;
    ...
    _initHlsjs() {
        ...
        this.hls = new hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__(this.hlsjsConfig);
        this._executeHooksFor('beforeinitialize');
        this.hls.on(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["Events"].ERROR, (event, data) => this._onError(event, data));
        this.hls.on(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["Events"].AUDIO_TRACKS_UPDATED, () => this._onAudioTracks());
        this.hls.on(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["Events"].MANIFEST_PARSED, (event, data) => this._onMetaData(event, data)); // FIXME: typings
        this.hls.on(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_0__["Events"].LEVEL_LOADED, (event, data) => {
...
/* harmony import */ var p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! p2p-media-loader-hlsjs */ "./node_modules/p2p-media-loader-hlsjs/dist/index.js");
/* harmony import */ var p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! p2p-media-loader-core */ "./node_modules/p2p-media-loader-core/dist/index.js");
/* harmony import */ var p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! hls.js/dist/hls.light.js */ "./node_modules/hls.js/dist/hls.light.js");
/* harmony import */ var hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_5__);
...
class P2pMediaLoaderPlugin extends Plugin {
    constructor(player, options) {
        ...
        if (!video_js__WEBPACK_IMPORTED_MODULE_0___default.a.Html5Hlsjs) {
            ...
            Object(p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_1__["initVideoJsContribHlsJsPlayer"])(player);
        }
    ...
    initializePlugin() {
        Object(p2p_media_loader_hlsjs__WEBPACK_IMPORTED_MODULE_1__["initHlsJsPlayer"])(this.hlsjs);
        // FIXME: typings
        const options = this.player.tech(true).options_;
        this.p2pEngine = options.hlsjsConfig.loader.getEngine();
        this.hlsjs.on(hls_js_dist_hls_light_js__WEBPACK_IMPORTED_MODULE_5__["Events"].LEVEL_SWITCHING, (_, data) => {
            this.trigger('resolutionChange', { auto: this.hlsjs.autoLevelEnabled, resolutionId: data.height });
        });
        this.p2pEngine.on(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__["Events"].SegmentError, (segment, err) => {
    ...
    runStats() {
        this.p2pEngine.on(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__["Events"].PieceBytesDownloaded, (method, size) => {
            const elem = method === 'p2p' ? this.statsP2PBytes : this.statsHTTPBytes;
            elem.pendingDownload.push(size);
            elem.totalDownload += size;
        });
        this.p2pEngine.on(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__["Events"].PieceBytesUploaded, (method, size) => {
            const elem = method === 'p2p' ? this.statsP2PBytes : this.statsHTTPBytes;
            elem.pendingUpload.push(size);
            elem.totalUpload += size;
        });
        this.p2pEngine.on(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__["Events"].PeerConnect, () => this.statsP2PBytes.numPeers++);
        this.p2pEngine.on(p2p_media_loader_core__WEBPACK_IMPORTED_MODULE_2__["Events"].PeerClose, () => this.statsP2PBytes.numPeers--);
