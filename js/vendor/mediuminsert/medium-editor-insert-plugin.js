...
; (function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            label: '<span class="fas fa-play"></span>',
    ...
    Embeds.prototype.oembed = function (url, pasted) {
        ...
        console.log('oembed0, ', url, pasted)
    ...
    Embeds.prototype.embed = function (html, pastedUrl) {
        ...
        if (!html) {
            ...
            if (pastedUrl) {
                ...
                $place = this.$el.find(":not(iframe, script, style, .js-player)")
                    .contents().filter(
                        function () {
...
; (function ($, window, document, Util, undefined) {
        ...
        var that = this,
            ...
            fileUploadOptions = {
                ...
                add: function (e, data) {
                    ...
                    //$.proxy(that, 'uploadDone', e, url, data)();
                }
            };
        ...
        if (data.autoUpload || (data.autoUpload !== false && $(e.target).fileupload('option', 'autoUpload'))) {
            data.process().done(function () {
                ...
                if (that.options.preview) {
                    ...
                    that.options.upload(img, function(url){
    ...
    Images.prototype.uploadDone = function (url, data) {
        ...
        $.proxy(this, 'uploadProgress', null, data)();
    ...
    Images.prototype.showImage = function (img, data) {
        ...
        if (this.options.preview && data.context) {
            ...
            if (this.options.preview) {
                ...
                that.options.upload(img, function(url){
                    $.proxy(that, 'uploadDone', url, data)();
                    //that.options.fileUploadOptions.done(url, data)
    ...
    Images.prototype.removeImage = function (e) {
        ...
        if (e.which === 8 || e.which === 46) {
            ...
            if (selection && selection.rangeCount) {
                ...
                if ($sibling && $sibling.hasClass('medium-insert-images') && !images.length) {

                    var _cs = 'figure:nth-last-child(1) '

                    if(n) _cs = 'figure:nth-child(1) '

                    images.push($sibling.find(_cs + 'img'));
                }
