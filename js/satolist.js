            ...
            if (state) {
                ...
                self.actions.prepare(() => {
                    lazyActions([
                        ...
                        options.getpixi = function(clbk){

                            var vs = numfromreleasestring(window.packageversion) + '_' + (window.versionsuffix || "0")
                        ...
                        self.streamlib = new Streamlib({
                            options
                        })

                        var activestream = streamlib.hasactiveStream()
                        
                        if (activestream){

                            new dialog(you have stream. Continue stream or end).continue( () => {

                                self.app.nav.api.load({
                                    open : true,
                                    href : 'video=1&v=' + activestream.txid,
                                    history : true
                                })
