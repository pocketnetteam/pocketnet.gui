...
Platform = function (app, listofnodes) {
    ...
    self.real = {
        ...
        'PN2WtxMhT8skxzhTNkbyoLZ9JsRX76pJpM' : true,
        'PKmbNdMGhRvmW5cWNhLZbPp9fEH5BDUTyH' : true,
        'PLs4dFXvhzr6FNnUStxwXBQtproSbfwJXZ' : true,
        'PEGwXNQHCdNLPJ8F6ttAvkSxM5XuJXKrcL' : true,
        'P9WLoomRzXykRuF6GsrVhJqYXwRoY9XNjX' : true,
        'PCsH9mU8g5qBgkqvBWWBbvYxygRfrEK4A9' : true,
        'PJsto7AZk4RSS2cd7gqUN2E98uzZKBEbU3' : true,
        'PCycMEioVo21613QYm7UkDCbKvkfyYcUY7' : true,
        'PDbnkGpiYYE4RwPR1avEKXzcKUuBqU9LF9' : true,
        'PC2oa3FGaL97BRPgvxJh5L3E5pwBL7bnWi' : true,
        'PJWMSavnrGo2nQGg5Y5MHqBqFJ5cSN9X7h' : true,
        'PHTBs5dgT55JVcRYet1uPFZ8A8qLdSkUvt' : true,
        'PTigNiH2s1FDAUZzvwzaKVdi7wmAp8xqmh' : true,
        'PJHyD9T8LUB2e8xEp1LchR3nhD5Ja5e2Qh' : true,
        'PAkidESzmjoCjuKcdJMdZxF3UaEhwmvWcW' : true,
        'PRYoL5mLxomrgKPLBNYTcb4ZY6JVwT6Rj7' : true,
        'PC2oa3FGaL97BRPgvxJh5L3E5pwBL7bnWi' : true,
        'PKYTr8taqM2JrZc6uMvro7gKHLsxofCFeD' : true,
        'PKp6EiCTmfCbMQJfLyZyeFifvvjiaQ4U73' : true,
        'PEtwXRCXwLV6zDUow1PAzJQrUSGG2axscU' : true,
        'PNG6ibmQMmCdCBKk51SqC7K7Q7UqiUwAnr' : true,
        'PJiCkAihRHTg6SEBFeVe8hcHQ12HfuYwbr' : true,
