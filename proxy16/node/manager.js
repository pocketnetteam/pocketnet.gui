...
var Nodemanager = function(p){
    ...
    self.cleardatabase = function(){
        ...
        return new Promise((resolve, reject) => {
            ...
            db.remove({ version: {$in : ['0.20.29', '0.20.27', '0.20.26', '0.20.25', '0.20.24', '0.20.23', '0.20.22', '0.20.21', '0.20.20', '0.20.19', '0.20.16', '0.20.17', '0.20.18', '0.20.16', '0.20.15', '0.20.14']}  }, { multi: true }, function (err, numRemoved) {
